    ...
    <div class="card text-start mt-2 shadow-sm px-2">
        <div class="card-body mb-5">
            ...
            <div class="d-flex justify-content-center mt-3">
                <form id="scrapForm" method="POST" action="{{ route('scrapan1.store') }}" class="col-12"
                    enctype="multipart/form-data">
                    @csrf @method('post')
                    <div class="row row-cols-lg-2">
                        <input type="text" hidden value="Reviewing" name="post_status">
                        <div class=" mb-3">
                        ...
                        <div class="w-100 mb-3">
                            <label for="about" class="form-label w-100 text-start">About</label>
                            <div class="">
                        ...
                        <div class=" mb-3">
                            <label for="size" class="form-label w-100 text-start">Size</label>
                            <div class="">
                        ...
                        {{-- <div class=" mb-3">
                        <label for="downloads" class="form-label w-100 text-start">Downloads</label>
                        <div class="">
                        ...
                        <div class=" mb-3">
                            <label for="online_or_offline" class="form-label w-100 text-start">Online or
                                Offline</label>
                            <div class="">
                        ...
                        <div class=" mb-3">
                            <label for="logo" class="form-label w-100 text-start">Logo</label>
                            ...
                            <div class="image-upload-container mt-3 g-2 row" id="imageUploadContainer1">
                                <div class="image-preview-container col-12" data-file-name="{{ $game->logo }}">
                                    <img src="{{ $game->logo }}" class="image-preview" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="w-100 mb-3">
                            <div class="input-group rounded-3 bg-light shadow-sm border border-bottom-0 rounded-bottom-0"
                                ...
                                <label class="form-label w-100 text-start p-2 m-0 w-100">Download
                                    Links</label>

                                @foreach ($game->download_links as $link)
                                    <div class="mt-2 d-flex flex-lg-row downloadlinks_input_container flex-column p-0 col-12"
                                        ...
                                        <div class="p-0 col-lg-6 col-12">
                                            <input type="text" class="form-control rounded-0 appLink"
                                                ...
                                                placeholder="If needed!" required value="{{ $link['link'] }}">
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="w-100 mb-3 ">
                        <div class="input-group rounded-3 bg-light shadow-sm border border-bottom-0 rounded-bottom-0"
                            id="">
                            <label class="form-label w-100 text-start p-2 m-0 w-100">Post
                                Setting</label>
                    ...
                    <div class=" mb-0 col-12">
                        <div class="">
                            <button type="submit" class="btn mb-2 w-100 btn-primary rounded-0 btn-info text-white">
                                {{ __('CREATE') }}
                            </button>
                        </div>
