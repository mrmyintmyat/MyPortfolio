        ...
        <div class="card-body pt-0 pt-lg-2">
            <div class="border-bottom border-2">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link col-6 active" id="nav-public-tab" data-bs-toggle="tab" data-bs-target="#nav-public"
                        type="button" role="tab" aria-controls="nav-public" aria-selected="true">PUBLIC</button>
                    <button class="nav-link col-6" id="nav-private-tab" data-bs-toggle="tab" data-bs-target="#nav-private"
                        ...
                        <div id="item_container" class="row row-cols-1 row-cols-lg-2 px-2">
                            @foreach ($public_games as $game)
                                <div class="col mt-2 p-0 row game_container_{{ $game->id }}">
                                        <div class="col-lg-10 col-11 pe-0">
                                            <a href="/admin/zynn/games/{{ $game->id }}/edit" id="card"
                                        ...
                                        <div class="col-lg-2 col-1 p-0">
                                            <button class="btn delete_game rounded-start-0 h-100 btn-warning"><i
